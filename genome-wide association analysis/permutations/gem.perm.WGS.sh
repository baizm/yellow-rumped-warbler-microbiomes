...
cp in_file_gemmaWGS* zzzzz/
cp gemmaWGS_covars_in.txt zzzzz/
...
shuf pheno | paste nopheno - > zzzzz/in_file_gemmaWGS.fam
...
gemma -bfile in_file_gemmaWGS -c gemmaWGS_covars_in.txt -k ./output/relatedness.cXX.txt -lmm 4 -o gem.perm
